...
var manifest = require('./projectResolver');
 ...
 */
function getRepos(providerName, user, options, callback) {
 ...
 * @returns {Function}
 */
function createGetInfoTask(providerName, user, repo) {
  logger.debug('createGetInfoTask: ', providerName, user, repo);

  return function(callback) {

    manifest.getManifest(providerName, user, repo.name, function(err, manifest) {
 ...
 */
module.exports.get = function(providerName, user, callback) {

  getRepos(providerName, user, function(err, repos) {
    ...
    async.parallel(
      repos.map(function(repo) {
        return createGetInfoTask(providerName, user, repo);
      }),
      function(err, data) {
