...
exports.checkProjectDir = function (providerName, user, repo, callback) {
  checkProvider(providerName, function (err, provider) {
    ...
    storage.getJsonData(provider, user, repo, projectInfoResolver.PROJECT_INFO, function (err, object) {
      if (err) {
        logger.error(err);
        return callback(err, null);
      }
...
exports.getManifest = function (providerName, user, repo, callback) {
  ...
  checkProvider(providerName, function (err, provider) {
    ...
    storage.getJsonData(provider, user, repo, projectInfoResolver.PROJECT_INFO, function (err, object) {
      ...
      storage.getJsonData(provider, user, repo, dependenciesStatusTask.REPORT, function (err, object) {
